...
var Emitter = class _Emitter {
  ...
  */
  ...
  init(config) {
    ...
    const behaviors2 = config.behaviors.map((data) => {
    ...
    behaviors2.push(PositionParticle);
    behaviors2.sort((a, b) => {
    ...
    this.initBehaviors = behaviors2.slice();
    this.updateBehaviors = behaviors2.filter((b) => b !== PositionParticle && b.updateParticle);
    this.recycleBehaviors = behaviors2.filter((b) => b !== PositionParticle && b.recycleParticle);
  }
  /**
